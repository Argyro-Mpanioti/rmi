...
Η κλάση περιέχει ως πεδία την λίστα accounts, που περιέχει όλους τους λογαριασμούς που δημιουργούνται ενώ τρέχει ο server, το ακέραιο authToken, που αυξάνεται κατά 1 κάθε φορά που δημιουργείται  .Όλα τα παραπάνω πεδία είναι global γιατί χρειαζόμαστε πρόσβαση σε αυτά από την κλάση RemoteMessagingApp.
